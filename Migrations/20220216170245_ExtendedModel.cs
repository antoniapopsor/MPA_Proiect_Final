    ...
    public partial class ExtendedModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Smartphone Store", x => new { x.SmartphoneID, x.StoreID });
                    table.ForeignKey(
                        name: "FK_Smartphone Store_Smartphone_SmartphoneID",
                        column: x => x.SmartphoneID,
                        principalTable: "Smartphone",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Smartphone Store_Store_StoreID",
                        column: x => x.StoreID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Smartphone Store_StoreID",
                table: "Smartphone Store",
                column: "StoreID");
        }
